        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col space-y-3">
              <a href="#pflege-begleitung" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Pflege & Begleitung
              </a>
              <a href="#abrechnung" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Abrechnung & Kosten
              </a>
              <a href="#ueber-mich" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Über uns
              </a>
            </nav>
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col space-y-3">
              <a href="#fuer-zuweisende" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group font-bold">
              ...
              <div className="pt-4 space-y-2">
                ...
                <p className="text-[13px] text-textDark/60 leading-relaxed italic">
                  Eng vernetzt mit Ärzten, Psychiatern und Sozialdiensten in der Region.
                </p>
              </div>
            </nav>
          </div>
