...
const DBTTool: React.FC = () => {
        ...
        return (
          <div className="p-8 flex flex-col h-full space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col items-center text-center space-y-4 pt-4">
              <div className="w-16 h-16 bg-white rounded-2xl shadow-sm border border-gray-50 flex items-center justify-center p-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] font-medium text-accentBrown/80 leading-relaxed max-w-[280px] mx-auto">
          ...
          <div className="flex flex-col h-full animate-in fade-in">
            ...
            <div className="flex-grow p-6 space-y-4 overflow-y-auto">
              ...
              <div className="space-y-2 pt-4">
                ...
                {!showSecondary && (
                  <button onClick={() => setShowSecondary(true)} className="w-full py-4 text-[10px] font-black text-accentBrown uppercase tracking-[0.2em] hover:bg-secondary/50 rounded-xl transition-all">+ Alle Skills dieser Zone anzeigen</button>
                )}
              </div>
            </div>
            ...
            <div className="flex-grow space-y-6">
              ...
              {skillStep.psychoEdu && (
                <div className="bg-accentGreen/5 p-6 rounded-[24px] border border-accentGreen/10 flex items-start space-x-4">
                  ...
                  <p className="text-sm text-textDark/70 leading-relaxed italic">{skillStep.psychoEdu}</p>
                </div>
              )}
            </div>
            ...
            <div className="flex-grow space-y-6">
              ...
              {selectedSkill?.psychoEdu && (
                <div className="bg-accentGreen/5 p-6 rounded-[24px] border border-accentGreen/10 flex items-start space-x-4">
                  ...
                  <p className="text-sm text-textDark/70 italic leading-relaxed">{selectedSkill.psychoEdu}</p>
                </div>
              )}
            </div>
  ...
  return <div className="h-full flex flex-col font-sans">{renderView()}</div>;
};
