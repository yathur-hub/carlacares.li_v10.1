        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
              <p className="text-xl md:text-2xl font-light text-accentGreen italic leading-tight text-center">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
             <div className="bg-white/10 backdrop-blur-md p-10 rounded-[40px] border border-white/10 space-y-6">
                ...
                <p className="opacity-60 italic">Arbeitet an innerpsychischen Prozessen und findet in der Regel in einer Praxis statt.</p>
             </div>
             <div className="bg-white p-10 rounded-[40px] shadow-2xl text-accentGreen space-y-6">
                ...
                <p className="text-textDark/70 italic">Unterstützt die praktische Umsetzung im Alltag.</p>
