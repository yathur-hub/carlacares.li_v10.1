      ...
      <section className="pb-32 px-6 bg-white text-center">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="bg-secondary/40 p-12 md:p-20 rounded-[60px] border border-gray-50 space-y-10">
             <h3 className="text-2xl md:text-4xl font-light text-accentGreen italic leading-tight max-w-3xl mx-auto">
             ...
             <p className="text-lg text-textDark/60 max-w-2xl mx-auto leading-relaxed pt-8 border-t border-accentGreen/5">
