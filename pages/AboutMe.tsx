...
const AboutMe: React.FC<AboutMeProps> = ({ onNavigateToKontakt }) => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* Sektion: Erfahrung im psychiatrischen Versorgungsalltag */}
      <section className="py-24 px-6 bg-secondary/30 border-y border-gray-100 overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl md:text-5xl font-extrabold text-accentGreen tracking-tight">Erfahrung im psychiatrischen Versorgungsalltag</h2>
            <div className="space-y-6 text-lg text-textDark/70 leading-relaxed">
              <p>
                Psychische Erkrankungen zeigen sich selten isoliert. Sie wirken sich auf den Alltag, auf Beziehungen, auf Selbstständigkeit und auf das soziale Umfeld aus.
              </p>
              <p>
                In meiner beruflichen Laufbahn habe ich Menschen in akuten Krisen, in länger anderauernden Belastungssituationen und in Übergangsphasen begleitet – etwa nach stationären Aufenthalten oder bei instabilen Lebenslagen.
              </p>
              <p className="bg-accentGreen p-6 rounded-2xl border-l-4 border-accentBrown shadow-lg text-white font-medium">
                Diese Erfahrung ermöglicht es mir, Situationen realistisch einzuschätzen und Unterstützung dort anzusetzen, wo sie im Alltag tatsächlich gebraucht wird.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="bg-secondary/20 p-8 rounded-3xl border border-dashed border-accentGreen/20 text-center">
             <p className="text-xl font-light text-accentGreen italic">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="bg-secondary/40 p-12 md:p-20 rounded-[60px] border border-gray-50 space-y-8">
             <h3 className="text-2xl md:text-4xl font-light text-accentGreen italic leading-tight">
               "Vertrauen entsteht durch Zeit, Klarheit und Verlässlichkeit."
             </h3>
