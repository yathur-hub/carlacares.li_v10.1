      ...
      <section className="py-24 px-6 bg-secondary/30 border-y border-gray-100 overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-8">
            ...
            <p className="text-base italic text-textDark/60">
              Die Pflege richtet sich nicht nach Diagnosen, sondern nach dem funktionalen Unterstützungsbedarf.
            </p>
          </div>
          <div className="relative">
             <div className="aspect-[4/5] bg-white rounded-[60px] p-4 shadow-xl border border-gray-50 flex items-center justify-center">
                <div className="text-center space-y-4">
                   ...
                   <span className="block text-accentBrown font-black uppercase tracking-widest text-xs">Fokus: Alltagsbewältigung</span>
                </div>
             </div>
          </div>
        </div>
